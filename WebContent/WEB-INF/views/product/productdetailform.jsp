...
<body>
	...
	<div class="product-detail">
		...
		<form action="/Cart.do" method="post">
			<input type="hidden" name="productId" value="${product.prodId}" /> <input
				type="hidden" name="custId" value="2" /> <input type="number"
				name="cartQuantity" value="0" min="0" /> <input type="hidden"
				name="action" value="addCart" />
